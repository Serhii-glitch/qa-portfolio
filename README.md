...
This repository contains my practical QA work based on testing a real volunteer project — **School Heroes (CMS + Android application)**.
...
- Performed retesting after fixes
...
Includes:
- Schedule (Events) acceptance criteria
...
- Negative testing  
- Edge case testing  
- Basic security testing (XSS, input validation)
...
- LinkedIn: https://www.linkedin.com/in/serhii-kurasov-555309387/
